...
![Chocolatey](images/choco.PNG "choco -v")
...
![Modern Terminal](images/modernterminal.PNG "About")
...
![Visual Studio Code](images/vscode.PNG "VSCode About")
...
```bash
git config --global user.name "Pavan Kumar Reddy Yanamala"
git config --global user.email "ypreddy.yanamala@gmail.com"
```
...
![VirtualBox About](images/virtualbox.PNG "vboxmanage --version")
